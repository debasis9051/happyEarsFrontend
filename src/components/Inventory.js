    ...
    const filteredProductList = useMemo(() => {
        return branchFilter ? productList.filter(x => x.branch_id === branchFilter.value).filter(x => {
            ...
            if (searchBarState && searchValue !== "") {
                if ((reg.test(x.manufacturer_name)) || (reg.test(x.product_name)) || (reg.test(x.serial_number))) {
                    return true
                }
                return false
            }
                                                        ...
                                                        <td>
                                                            <Dropdown>
                                                                ...
                                                                <Dropdown.Menu>
                                                                        ...
                                                                        <>
                                                                                    ...
                                                                                    Swal.fire({
                                                                                        ...
                                                                                        preConfirm: async (reason) => {
                                                                                            try {
                                                                                                ...
                                                                                                return await axios.post(`${process.env.REACT_APP_BACKEND_ORIGIN}/return-product`, data, { headers: { 'Content-Type': 'application/json' } })
                                                                                            } catch (error) {
                                                                                                console.log(error)
                                                                            ...
                                                                            <Dropdown.Item
                                                                                onClick={() => {
                                                                                    Swal.fire({
                                                                                        title: "Are you sure?",
                                                                                        text: "You won't be able to revert this! This will delete the product permanently along with its log history.",
                                                                                        icon: "warning",
                                                                                        showCancelButton: true,
                                                                                        showLoaderOnConfirm: true,
                                                                                        preConfirm: async (val) => {
                                                                                            try {
                                                                                                ...
                                                                                                return await axios.post(`${process.env.REACT_APP_BACKEND_ORIGIN}/products/${x.id}`, data, { headers: { 'Content-Type': 'application/json' } })
                                                                                            } catch (error) {
                                                                                                console.log(error)
                                                                                                Swal.showValidationMessage(error.message);
                                                                                            }
                                                                            ...
                                                                            try {
                                                                                ...
                                                                                setModalData({
                                                                                    submitCallback: (printConfigData) => {
                                                                                        printInvoice(invoice.patient_details, invoice.branch_id, invoice.invoice_number, moment.unix(invoice.date._seconds).format("DD-MM-YYYY"), invoice.mode_of_payment, invoice.discount_amount, invoice.line_items, invoice.accessory_items, printConfigData, branchList)
                                                                                    }
                                                                                })
                                                                                openModal()
                                                                            } catch (error) {
                                                                    ...
                                                                    >View Associated Invoice</Dropdown.Item>
                                                                </Dropdown.Menu>
                                                            </Dropdown>
                                                        </td>
                                                    </tr>
